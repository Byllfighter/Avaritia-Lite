...
public record NeutroniumCompressorGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(AvaritiaMod.MODID, "neutronium_compressor_gui_buttons");
	...
	public static void handleData(final NeutroniumCompressorGuiButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AvaritiaMod.addNetworkMessage(NeutroniumCompressorGuiButtonMessage.ID, NeutroniumCompressorGuiButtonMessage::new, NeutroniumCompressorGuiButtonMessage::handleData);
	}
}
