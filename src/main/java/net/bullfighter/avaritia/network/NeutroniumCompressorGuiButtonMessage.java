...
public record NeutroniumCompressorGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	}, (RegistryFriendlyByteBuf buffer) -> new NeutroniumCompressorGuiButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt()));
	@Override
	public Type<NeutroniumCompressorGuiButtonMessage> type() {
		return TYPE;
	}

	public static void handleData(final NeutroniumCompressorGuiButtonMessage message, final IPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AvaritiaMod.addNetworkMessage(NeutroniumCompressorGuiButtonMessage.TYPE, NeutroniumCompressorGuiButtonMessage.STREAM_CODEC, NeutroniumCompressorGuiButtonMessage::handleData);
	}
}
