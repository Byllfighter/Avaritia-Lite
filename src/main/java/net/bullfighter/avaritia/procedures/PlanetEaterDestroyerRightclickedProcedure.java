...
public class PlanetEaterDestroyerRightclickedProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		ItemStack hammer = ItemStack.EMPTY;
		if (entity.isShiftKeyDown()) {
			hammer = new ItemStack(AvaritiaModItems.PLANET_EATER.get());
			{
			...
			} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == AvaritiaModItems.PLANET_EATER_DESTROYER.get()) {
				if (entity instanceof LivingEntity _entity) {
					ItemStack _setstack = hammer.copy();
					_setstack.setCount(1);
